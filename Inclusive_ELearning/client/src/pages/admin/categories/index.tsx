...
const AdminCategory = (props: any) => {
    ...
    const columns = [
        ...
        },
        {
            ...
            key: 'anhdanhmuc',
            render: (anhdanhmuc) => <img src={anhdanhmuc} alt="Ảnh danh mục" style={{ width: 100 }} />,
          },
        {
            title: "Hành động",
    ...
    return (
        <div>
            <header className="flex items-center justify-between mb-4">
                <h2 className="text-2xl">Quản lý thương hiệu</h2>
                <Button type="primary" danger>
                    <Link to="/admin/category/add">Thêm thương hiệu</Link>
                </Button>
            </header>
            {contextHolder}
