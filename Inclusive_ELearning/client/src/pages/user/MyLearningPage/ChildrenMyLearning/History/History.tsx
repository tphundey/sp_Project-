            ...
            {orders.length > 0 ? (
                <ul>
                    {orders.map(order => {
                        ...
                        if (order.status === "Đơn hàng chờ xác nhận" || order.status === "Đơn hàng đang được đóng gói" || order.status === "Đơn hàng đang được giao cho đơn vị vận chuyển" || order.status === "Đơn hàng đang được giao" || order.status === "Đơn hàng đang hoàn trả") {
